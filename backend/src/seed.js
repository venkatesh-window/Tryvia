...
export async function seed() {
  try {
    ...
    const brandKiehls = await Brand.create({
      ...
      logoUrl:
        "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=300",
    });
    ...
    const brandLeLabo = await Brand.create({
      ...
      logoUrl:
        "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?q=80&w=300",
    });
    ...
    const catSkincare = await Category.create({
      ...
      slug: "skincare",
      description:
        "Hydrating serums, restoring night creams, and botanical oils",
      imageUrl:
    ...
    const catFragrance = await Category.create({
      ...
      slug: "fragrance",
      description:
        "Rare artisanal extrait de parfum and iconic French fragrances",
      imageUrl:
    ...
    const catMakeup = await Category.create({
      ...
      slug: "makeup",
      description:
        "Satin lipsticks, glow oils, and couture cosmetic formulations",
      imageUrl:
    ...
    const catGiftSets = await Category.create({
      ...
      slug: "gift-sets",
      description:
        "Curated discovery discovery sampler boxes and mini collections",
      imageUrl:
    ...
    const productsData = [
      {
        ...
        description:
          "A luxurious, lightweight cream that visibly plumps and smooths your skin while you sleep with botanical squalane and evening primrose.",
        fullPrice: 5200,
        testerPrice: 300,
        stockFull: 25,
        stockTester: 50,
      ...
      },
      {
        ...
        description:
          "An intimate, seductive oriental fragrance with luminous bergamot, velvety May rose, and intoxicating patchouli sillage.",
        fullPrice: 14500,
        testerPrice: 350,
        stockFull: 15,
        stockTester: 40,
      ...
      },
      {
        ...
        description:
          "Nourishing glossy lip oil infused with cherry oil that enhances natural lip color with mirror-like shine and deep hydration.",
        fullPrice: 3800,
        testerPrice: 250,
        stockFull: 30,
        stockTester: 60,
      ...
      },
      {
        ...
        description:
          "A powerful blend of crisp Calabrian bergamot, smoky vanilla absolute, and radiant woody amber facets.",
        fullPrice: 11500,
        testerPrice: 350,
        stockFull: 20,
        stockTester: 45,
      ...
      },
      {
        ...
        description:
          "The most intense expression of Bleu de Chanel. An aromatic, intensely woody fragrance with refined sandalwood.",
        fullPrice: 12800,
        testerPrice: 350,
        stockFull: 18,
        stockTester: 35,
      ...
      },
      {
        ...
        description:
          "An intoxicating icon of smoky cardamom, iris, violet, and creamy Australian sandalwood notes.",
        fullPrice: 24000,
        testerPrice: 450,
        stockFull: 10,
        stockTester: 25,
    ...
    console.log(
      `👤 Seeded test user: ${testUser.email} (password: password123)`,
    );
...
if (process.argv[1] && (process.argv[1].endsWith('seed.js') || process.argv[1].endsWith('seed.ts'))) {
  mongoose.connect(mongoURI)
    ...
    .catch(err => {
      console.error("❌ Direct seeding connection failed:", err);
      process.exit(1);
    });
}
