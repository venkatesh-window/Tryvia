...
export interface IWalletRule extends Document {
  minTesterPurchase: number;
...
const WalletRuleSchema = new Schema<IWalletRule>(
  {
...
export const WalletRule = mongoose.model<IWalletRule>('WalletRule', WalletRuleSchema);
