...
import { Sparkles, CreditCard, ShoppingBag } from "lucide-react-native";
    ...
    <ScreenContainer>
      <View style={[styles.container, { paddingTop: insets.top + 16 }]}>
        <View style={styles.headerTopRow}>
          ...
          <View style={styles.headerRightActions}>
            ...
            >
              ...
              <Typography style={styles.walletText}>
                ₹{walletBalance}
              </Typography>
            </TouchableOpacity>
            <TouchableOpacity
        ...
        <Typography variant="body" color="secondary" style={styles.subtitle}>
          Try samples for ₹200-₹350 and unlock 90% wallet upgrade credits
        </Typography>
        ...
        >
          ...
          >
            <View style={styles.promoTextContainer}>
              ...
              >
                TRYVIA SMART UPGRADE
              </Typography>
            </View>
            <Typography variant="h3" weight="bold" style={styles.promoHeading}>
              Try for <Text style={{ fontFamily: "Inter_700Bold" }}>₹250</Text>{" "}
              → Get <Text style={{ fontFamily: "Inter_700Bold" }}>₹225</Text>{" "}
              Credit
            </Typography>
            <Typography variant="body" color="secondary">
              Order any mini today. 90% of your mini spend is credited to your
              TryVia Wallet to upgrade to full size later!
            </Typography>
          </Animated.View>
          ...
          <View style={styles.grid}>
            {products?.map((item, idx) => (
              <Animated.View
                key={item.id}
                entering={FadeInUp.duration(450).delay(
                  250 + Math.min(idx, 6) * 60,
                )}
