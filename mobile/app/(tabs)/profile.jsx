    ...
    <ScreenContainer>
      ...
      <View
        style={[
          ...
          { paddingTop: insets.top > 0 ? insets.top + 6 : 16 },
        ]}
      >
      ...
      >
        ...
        {isAuthenticated && user ? (
          <Animated.View
            entering={FadeInUp.duration(550).delay(100)}
          ...
          >
            ...
            <Typography style={styles.guestSub}>
              Sign in to unlock exclusive luxury mini perks, 90% upgrade
              credits, and tracked shipments.
            </Typography>
            <TouchableOpacity
            ...
            >
              <Typography style={styles.guestSignInText}>
                Sign In / Join TryVia
              </Typography>
            </TouchableOpacity>
          </Animated.View>
        ...
        {/* Menu Items Card */}
        <Animated.View
          entering={FadeInUp.duration(550).delay(220)}
