      ...
      >
              ...
              <View style={[styles.bannerSlide, { width: bannerWidth }]}>
                <View style={styles.bannerCard}>
                  ...
                  <View style={styles.bannerLeft}>
                    ...
                    <Typography style={styles.bannerHeading}>
                      {item.heading}
                    </Typography>
                    <Typography style={styles.bannerDesc}>
                      {item.desc}
                    </Typography>
                    <TouchableOpacity
                    ...
                    >
                      <Typography style={styles.exploreBtnText}>
                        {item.btnText}
                      </Typography>
                    </TouchableOpacity>
                  </View>
        ...
        >
          ...
          <TouchableOpacity
            style={styles.quickLinkBtn}
            activeOpacity={0.8}
            onPress={() => router.push("/(tabs)/minis")}
          >
            <Sparkles
              size={18}
              color="#1A1918"
              ...
              return (
                ...
                >
                  ...
                  >
                    <IconComponent
                      size={26}
                      color={isSelected ? "#CB6D73" : "#1A1918"}
                      strokeWidth={1.5}
                    />
                  </View>
                  <Typography
        ...
        >
          <View style={styles.sectionHeaderRow}>
            ...
            {filteredProducts.length > 0 && (
              <Typography style={styles.picksCountText}>
