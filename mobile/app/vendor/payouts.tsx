...
export default function VendorPayoutsScreen() {
  ...
  const fetchPayouts = async () => {
    try {
      const response = await apiClient.get('/payouts/vendor');
  ...
  const handleRequestPayout = async () => {
    ...
    try {
      await apiClient.post('/payouts/request', { amount: amt });
      await fetchPayouts();
    } catch (err: any) {
...
const styles = StyleSheet.create({
  ...
  requestCard: { backgroundColor: '#FFFFFF', marginHorizontal: 16, borderRadius: 16, borderWidth: 1, borderColor: '#ECE7E1', padding: 16, marginBottom: 24 },
  ...
  requestBtn: { backgroundColor: '#1A1918', paddingHorizontal: 16, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
  ...
  listCard: { backgroundColor: '#FFFFFF', marginHorizontal: 16, borderRadius: 16, borderWidth: 1, borderColor: '#ECE7E1', padding: 16, marginBottom: 24 },
  ...
  listItemBodyRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  tdDate: { fontFamily: 'Inter_500Medium', fontSize: 13, color: '#8E8A85', marginBottom: 4 },
  tdRef: { fontFamily: 'Inter_500Medium', fontSize: 11, color: '#8E8A85' },
  tdName: { fontFamily: 'Inter_600SemiBold', fontSize: 14, color: '#1A1918', marginBottom: 4 },
  tdSub: { fontFamily: 'Inter_500Medium', fontSize: 12, color: '#8E8A85' },
  tdValue: { fontFamily: 'Inter_600SemiBold', fontSize: 16, color: '#1A1918' },
