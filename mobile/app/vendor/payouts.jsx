...
import { Wallet, Activity, DollarSign } from "lucide-react-native";
...
export default function VendorPayoutsScreen() {
  ...
  const fetchPayouts = async () => {
    try {
      ...
      setData(json);
      setAmountInput(
        json.balances?.availableBalance > 0
          ? String(json.balances.availableBalance)
          : "",
      );
    } catch (e) {
      if (
        ...
        <View style={styles.requestRow}>
          ...
          <TouchableOpacity
            style={[
              ...
              (!balances.availableBalance ||
                balances.availableBalance < 50) && { opacity: 0.5 },
            ]}
          ...
          >
            {requesting ? (
              ...
              <Typography style={styles.requestBtnText}>
                Request Funds
              </Typography>
            )}
          </TouchableOpacity>
              ...
              <View key={idx} style={styles.listItem}>
                <View style={styles.listItemHeader}>
                  ...
                  <Typography
                    style={[
                      styles.tdValue,
                      l.amount < 0 && { color: "#D9383A" },
                      l.amount > 0 && { color: "#318C59" },
                    ]}
                  >
                    {l.amount > 0 ? "+" : ""}
                    {l.amount.toFixed(2)}
                ...
                <View style={styles.listItemBodyRow}>
                  <View>
                    ...
                    <Typography style={styles.tdSub} numberOfLines={1}>
                      {l.notes || l.reference}
                    </Typography>
                  </View>
                  <View
