...
export default function VendorNotificationsScreen() {
  ...
  const getIcon = (type) => {
    switch (type) {
      case "ORDER":
        return <Package size={20} color="#D9985F" />;
      case "PAYOUT":
        return <Wallet size={20} color="#318C59" />;
      case "RETURN":
        return <ArrowLeftRight size={20} color="#D9383A" />;
      default:
        return <Bell size={20} color="#8E8A85" />;
    }
  };
        ...
        {notifications.length === 0 ? (
          ...
          notifications.map((n, idx) => (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Typography
                  style={[styles.cardTitle, !n.read && styles.unreadText]}
                >
                  {n.title}
                </Typography>
                <Typography style={styles.cardDesc}>{n.description}</Typography>
                <Typography style={styles.cardDate}>
