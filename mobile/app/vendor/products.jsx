        ...
        {products.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Typography style={styles.emptySubtext}>
              Add your first product to start selling on TRYVIA.
            </Typography>
            <TouchableOpacity
          ...
          <View style={styles.productsList}>
            {filteredProducts.map((product, idx) => (
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                onPress={() => router.push(`/vendor/products/${product._id}`)}
              >
                ...
                <View style={styles.productInfo}>
                  ...
                  <View style={styles.productFooter}>
                    ...
                    <Typography style={styles.productStock}>
