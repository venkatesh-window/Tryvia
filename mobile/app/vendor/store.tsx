...
export default function VendorStoreScreen() {
  ...
  const [activeTab, setActiveTab] = useState<'profile' | 'business' | 'bank' | 'security'>('profile');
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputWrapper}>
                <TextInput style={styles.input} value={form.storeName} onChangeText={(val) => setForm({...form, storeName: val})} />
              </View>
            </View>

            <View style={styles.inputGroup}>
              <Typography style={styles.inputLabel}>STORE SLUG (Public URL)</Typography>
              <View style={styles.inputWrapper}>
                <Typography style={{ color: '#8E8A85' }}>tryvia.com/store/</Typography>
                <TextInput style={styles.input} value={form.slug} onChangeText={(val) => setForm({...form, slug: val.toLowerCase().replace(/[^a-z0-9-]/g, '-')})} />
              </View>
            </View>

            <View style={styles.inputGroup}>
              <Typography style={styles.inputLabel}>STORE DESCRIPTION</Typography>
            ...
            <TouchableOpacity style={styles.saveBtn} onPress={handleSaveProfile} disabled={saving}>
              {saving ? <ActivityIndicator size="small" color="#FFFFFF" /> : (
                <>
                  ...
                  <Typography style={styles.saveBtnText}>Save Profile</Typography>
                </>
              )}
            </TouchableOpacity>
          </View>
        ...
        {activeTab === 'business' && (
          <View style={styles.card}>
            ...
            <View style={styles.inputGroup}>
              <Typography style={styles.inputLabel}>BUSINESS ADDRESS</Typography>
            ...
            <TouchableOpacity style={styles.saveBtn} onPress={handleSaveProfile} disabled={saving}>
              {saving ? <ActivityIndicator size="small" color="#FFFFFF" /> : (
                <>
                  <Save size={16} color="#FFFFFF" />
                  <Typography style={styles.saveBtnText}>Save Business Info</Typography>
                </>
              )}
            </TouchableOpacity>
          </View>
        ...
        {activeTab === 'bank' && (
          <View style={styles.card}>
            <View style={styles.inputGroup}>
              <Typography style={styles.inputLabel}>ACCOUNT HOLDER NAME</Typography>
              <View style={styles.inputWrapper}>
                <TextInput style={styles.input} value={form.payoutAccount.accountName} onChangeText={(val) => setForm({...form, payoutAccount: {...form.payoutAccount, accountName: val}})} />
              </View>
            </View>

            <View style={styles.inputGroup}>
              <Typography style={styles.inputLabel}>BANK ACCOUNT NUMBER</Typography>
              <View style={styles.inputWrapper}>
                <TextInput style={styles.input} value={form.payoutAccount.accountNumber} onChangeText={(val) => setForm({...form, payoutAccount: {...form.payoutAccount, accountNumber: val}})} secureTextEntry={form.payoutAccount.accountNumber.includes('XXXX')} onFocus={() => setForm({...form, payoutAccount: {...form.payoutAccount, accountNumber: ''}})} />
              </View>
              <Typography style={{ fontFamily: 'Inter_500Medium', fontSize: 11, color: '#8E8A85', marginTop: 4 }}>This will be securely masked upon saving.</Typography>
            </View>

            <View style={styles.inputGroup}>
              <Typography style={styles.inputLabel}>BANK NAME</Typography>
              <View style={styles.inputWrapper}>
                <TextInput style={styles.input} value={form.payoutAccount.bankName} onChangeText={(val) => setForm({...form, payoutAccount: {...form.payoutAccount, bankName: val}})} />
              </View>
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputWrapper}>
                <TextInput style={styles.input} value={form.payoutAccount.ifsc} onChangeText={(val) => setForm({...form, payoutAccount: {...form.payoutAccount, ifsc: val}})} autoCapitalize="characters" />
              </View>
            </View>
            ...
            <TouchableOpacity style={styles.saveBtn} onPress={handleSaveProfile} disabled={saving}>
              {saving ? <ActivityIndicator size="small" color="#FFFFFF" /> : (
                <>
                  <Save size={16} color="#FFFFFF" />
                  <Typography style={styles.saveBtnText}>Save Bank Details</Typography>
                </>
              )}
            </TouchableOpacity>
          </View>
        ...
        {activeTab === 'security' && (
          <View style={styles.card}>
            <View style={styles.inputGroup}>
              <Typography style={styles.inputLabel}>CURRENT PASSWORD</Typography>
              <View style={styles.inputWrapper}>
                <TextInput style={styles.input} value={passwordForm.currentPassword} onChangeText={(val) => setPasswordForm({...passwordForm, currentPassword: val})} secureTextEntry />
              </View>
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputWrapper}>
                <TextInput style={styles.input} value={passwordForm.newPassword} onChangeText={(val) => setPasswordForm({...passwordForm, newPassword: val})} secureTextEntry />
              </View>
            </View>

            <View style={styles.inputGroup}>
              <Typography style={styles.inputLabel}>CONFIRM NEW PASSWORD</Typography>
              <View style={styles.inputWrapper}>
                <TextInput style={styles.input} value={passwordForm.confirmPassword} onChangeText={(val) => setPasswordForm({...passwordForm, confirmPassword: val})} secureTextEntry />
              </View>
            </View>

            <TouchableOpacity style={[styles.saveBtn, { backgroundColor: '#D9383A' }]} onPress={handlePasswordChange} disabled={saving}>
              {saving ? <ActivityIndicator size="small" color="#FFFFFF" /> : (
                <>
                  <Lock size={16} color="#FFFFFF" />
                  <Typography style={styles.saveBtnText}>Update Password</Typography>
                </>
              )}
            </TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  ...
  errorBox: { backgroundColor: '#FDECEC', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#F8B4B4', marginBottom: 16 },
  errorText: { color: '#D9383A', fontFamily: 'Inter_500Medium', fontSize: 14 },
  successBox: { backgroundColor: '#E9F5EF', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#A3D9B8', marginBottom: 16 },
  successText: { color: '#318C59', fontFamily: 'Inter_500Medium', fontSize: 14 },
  saveBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#1A1918', paddingHorizontal: 16, paddingVertical: 14, borderRadius: 8, gap: 8, marginTop: 12 },
