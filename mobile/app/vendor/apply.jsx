...
export default function VendorApplyScreen() {
      ...
      >
        <View style={styles.card}>
          ...
          <Typography style={styles.subtitle}>
            Your TRYVIA vendor application is under review. You will be notified
            once approved.
          </Typography>
          <TouchableOpacity
  ...
  if (status === "REJECTED") {
    return (
      ...
      >
        <View style={styles.card}>
          <Typography style={[styles.title, { color: "#D9383A" }]}>
    ...
    >
      ...
      >
        <View style={styles.header}>
          ...
          <Typography style={styles.subtitle}>
            Partner with TRYVIA to sell your beauty products.
          </Typography>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputWrapper}>
              <Typography style={{ color: "#8E8A85", marginRight: 4 }}>
                tryvia.com/store/
              </Typography>
              <TextInput
                style={styles.input}
        ...
        <View style={styles.card}>
          <Typography style={[styles.inputLabel, { marginBottom: 16 }]}>
            BUSINESS VERIFICATION (Optional for now)
          </Typography>
