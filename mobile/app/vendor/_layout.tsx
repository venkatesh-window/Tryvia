...
import { View, StyleSheet, TouchableOpacity, ActivityIndicator, Text, useWindowDimensions, Modal, SafeAreaView } from 'react-native';
import { Stack, useRouter, usePathname, Redirect } from 'expo-router';
import { useAuthStore } from '../../src/store/useAuthStore';
import { Typography } from '../../src/components/ui/Typography';
import { LayoutDashboard, Package, ShoppingBag, Store, Settings, LogOut, User, Menu, X } from 'lucide-react-native';
  ...
  const SidebarContent = () => (
    <>
      ...
      <View style={styles.sidebarFooter}>
        <TouchableOpacity style={styles.navItem} onPress={() => navigateTo('/vendor/settings')}>
      ...
      <View style={styles.container}>
        ...
        {!isLoginRoute && isMobile && (
          <View style={styles.mobileHeader}>
            ...
            <Typography style={styles.mobileBrandTitle}>TryVia Vendor</Typography>
        ...
        {!isLoginRoute && isMobile && (
          ...
          >
            <View style={styles.modalOverlay}>
              <TouchableOpacity style={styles.modalDismiss} onPress={() => setIsSidebarOpen(false)} />
