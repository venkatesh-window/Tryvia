        ...
        <View style={styles.cardSheet}>
          ...
          <View style={styles.titleRow}>
            ...
            <View style={styles.miniatureBadge}>
              ...
              <Typography style={styles.miniatureBadgeText}>
                MINIATURE
              </Typography>
            </View>
          </View>

          <Typography style={styles.sizeLabel}>
            TRIAL & TESTER EDITION
          </Typography>
          <Typography style={styles.priceText}>
            ₹{product.tester_price}
          </Typography>
          ...
          <View style={styles.experienceSection}>
            ...
            <Typography style={styles.experienceBody}>
              Experience {product.name} without the commitment. This exquisite
              miniature contains enough product for an immersive trial on your
              skin. When you love it, 90% of your tester spend is credited to
              your Tryvia Wallet!
            </Typography>
