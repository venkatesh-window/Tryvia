...
export default function ProductDetailsScreen() {
  ...
  const [eligibleCredit, setEligibleCredit] = useState(null);
  ...
  const isFragrance =
    product.category?.name?.toLowerCase().includes("fragrance") ||
    product.name.toLowerCase().includes("parfum");
  const feature1 = isFragrance
    ? { icon: Sparkles, label: "Long Lasting\nSillage" }
    : { icon: Droplets, label: "Hydrating\nFormula" };
  const feature2 = isFragrance
    ? { icon: Leaf, label: "Natural Floral\nEssence" }
    : { icon: Leaf, label: "Lightweight\nTexture" };
  const feature3 = isFragrance
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.cardSheet}>
          ...
          {/* Brand Name */}
          <Typography style={styles.brandName}>
          ...
          <View style={styles.titleRow}>
            ...
            <View style={styles.authenticBadge}>
              ...
              <Typography style={styles.authenticBadgeText}>
                AUTHENTIC
              </Typography>
            </View>
          </View>
          ...
          <View style={styles.sizeRow}>
            ...
            >
              <Typography
                style={[
                  ...
                  selectedSize === "full" && styles.sizeOptionTextActive,
                ]}
              >
                FULL SIZE
              </Typography>
            ...
            <TouchableOpacity
              ...
              style={[
                styles.sizeOption,
                selectedSize === "tester" && styles.sizeOptionActive,
              ]}
            >
              <Typography
                style={[
                  styles.sizeOptionText,
                  selectedSize === "tester" && styles.sizeOptionTextActive,
                ]}
              >
                MINI (TRY FIRST)
              </Typography>
          ...
          >
            <Typography style={styles.addToCollectionText}>
              Add to Collection
            </Typography>
          ...
          {eligibleCredit && selectedSize === "full" && (
            <View style={{ marginBottom: 20 }}>
              <UpgradeWalletCard
                ...
                fullSizePrice={product.full_price}
                compact={true}
              />
            </View>
          )}
          ...
          <View style={styles.featuresCard}>
            <View style={styles.featureCol}>
              ...
              <Typography style={styles.featureLabel}>
                {feature1.label}
              </Typography>
            </View>
          ...
          <View style={styles.experienceSection}>
            <Typography style={styles.experienceHeading}>
              The Experience
            </Typography>
            <Typography style={styles.experienceBody}>
              {product.description ||
                "A luxurious, lightweight cream that visibly plumps and smooths your skin while you sleep."}
            </Typography>
