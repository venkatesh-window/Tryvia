...
import { X, CreditCard, Plus, Trash2, Smartphone } from "lucide-react-native";
import * as Haptics from "expo-haptics";
import { theme } from "../../theme/theme";
import { useSafeAreaInsets } from "react-native-safe-area-context";

export const PaymentMethodsModal = ({ visible, onClose }) => {
  const insets = useSafeAreaInsets();
  const { methods, addCard, addUpi, removeMethod, setDefaultMethod } =
              ...
              {!isAddingCard && (
                ...
                >
                  ...
                  <Typography
                    variant="caption"
                    weight="bold"
                    style={{ color: "#B8860B", marginLeft: 4 }}
                  >
                    Add Card
                  </Typography>
                </TouchableOpacity>
            ...
            {isAddingCard && (
              <View style={styles.addFormCard}>
                <Typography
                  variant="h3"
                  weight="medium"
                  style={{ color: theme.colors.text.primary, marginBottom: 12 }}
                >
                  Add Luxury Card
                </Typography>
                ...
                <View style={styles.brandRow}>
                  {["visa", "mastercard", "amex"].map((brand) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.brandChip,
                        newCardBrand === brand && styles.selectedBrandChip,
                      ]}
                  ...
                  {card.isDefault ? (
                    <View style={styles.defaultBadge}>
                      <Typography
                        variant="caption"
                        weight="bold"
                        style={{ color: "#B8860B", fontSize: 10 }}
                      >
                        DEFAULT
                      </Typography>
                    </View>
                    ...
                    <TouchableOpacity
                      onPress={() => setDefaultMethod(card.id)}
                      activeOpacity={0.7}
                    >
                      <Typography
                        variant="caption"
