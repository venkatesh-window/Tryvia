...
export const MockPaymentGatewayModal = ({
  visible,
  deliveryAddress,
  onClose,
  onSuccess,
  ...
  const { items, total, walletDeduction, clearCart, appliedWalletCredit } =
    useCartStore();
            ...
            >
              ...
              <View style={styles.tabsRow}>
                <TouchableOpacity
                  style={[
                    styles.tabItem,
                    activeTab === "cod" && styles.activeTabItem,
                  ]}
                ...
                >
                  <Banknote
                    size={15}
                    color={activeTab === "cod" ? "#FFFFFF" : "#666666"}
                  />
                  <Typography
                    variant="caption"
                    weight="medium"
                    ...
                    style={[
                      styles.tabText,
                      activeTab === "cod" && styles.activeTabText,
                    ]}
                  >
                    COD
                  </Typography>
                ...
                >
                  <Smartphone
                    size={15}
                    color={activeTab === "upi" ? "#FFFFFF" : "#666666"}
                  />
                  <Typography
                    variant="caption"
                    weight="medium"
                ...
                <TouchableOpacity
                  style={[
                    styles.tabItem,
                    activeTab === "card" && styles.activeTabItem,
                  ]}
                ...
                >
                  <CreditCard
                    size={15}
                    color={activeTab === "card" ? "#FFFFFF" : "#666666"}
                  />
                  <Typography
                    variant="caption"
                    weight="medium"
                ...
                <TouchableOpacity
                  style={[
                    styles.tabItem,
                    activeTab === "netbanking" && styles.activeTabItem,
                  ]}
                ...
                >
                  <Building2
                    size={15}
                    color={activeTab === "netbanking" ? "#FFFFFF" : "#666666"}
                  />
                  <Typography
                    variant="caption"
                    weight="medium"
                    ...
                    style={[
                      styles.tabText,
                      activeTab === "netbanking" && styles.activeTabText,
                    ]}
                  >
                    Banking
                  </Typography>
                ...
                <View style={styles.tabSection}>
                  <View style={styles.codCard}>
                    ...
                    <Typography
                      variant="body"
                      color="secondary"
                      style={{ lineHeight: 21, fontSize: 13 }}
                    >
                      Pay ₹{total.toFixed(2)} comfortably via cash or any UPI QR
                      code scan presented by our courier upon parcel handover.
                    </Typography>
                    <View style={styles.codPerkRow}>
                      <ShieldCheck size={16} color="#16A34A" />
                      <Typography style={styles.codPerkText}>
                        Verified genuine tamper-evident packaging
                      </Typography>
                    </View>
                  </View>
                </View>
              ...
              {activeTab === "upi" && (
                <View style={styles.tabSection}>
                  ...
                  <View style={styles.upiGrid}>
                    {["Google Pay", "PhonePe", "Paytm", "Cred UPI"].map(
                      (app) => (
                        <TouchableOpacity
                          key={app}
                          style={[
                ...
                <View style={styles.tabSection}>
                  ...
                  {[
                    ...
                    >
                      <Building2
                        size={18}
                        color={selectedBank === bank ? "#121212" : "#888888"}
                      />
                      <Typography
                        variant="body"
                        weight={selectedBank === bank ? "semibold" : "regular"}
                        style={{
                          color: theme.colors.text.primary,
                          marginLeft: 12,
                        }}
