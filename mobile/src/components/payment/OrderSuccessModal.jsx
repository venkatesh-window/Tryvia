      ...
      <View style={styles.container}>
        ...
        >
          ...
          >
            ...
            >
              Thank you for shopping with Tryvia. Your bespoke luxury items are
              being carefully prepared.
            </Typography>
          </Animated.View>

          {/* Credits Added Banner */}
          {((order.items || []).filter(i => i.type === "tester").reduce((acc, i) => acc + i.price * i.quantity, 0)) > 0 && (
            <Animated.View
              entering={FadeInUp.duration(600).delay(300)}
              style={styles.cashbackBanner}
            >
              <Sparkles size={20} color="#B8860B" style={{ marginRight: 12 }} />
              <View style={{ flex: 1 }}>
                <Typography variant="body" weight="medium" style={{ color: "#B8860B" }}>
                  Purchase successful!
                </Typography>
                <Typography variant="caption" color="secondary" style={{ marginTop: 2 }}>
                  ₹{(order.items || []).filter(i => i.type === "tester").reduce((acc, i) => acc + i.price * i.quantity, 0)} credits added to your wallet.
                </Typography>
                <Typography variant="caption" weight="bold" style={{ color: theme.colors.text.primary, marginTop: 4 }}>
            ...
            <View style={styles.detailsCard}>
              <View style={styles.detailRow}>
                ...
                <Typography
                  variant="caption"
                  weight="bold"
                  style={{ color: "#B8860B", letterSpacing: 1, fontSize: 13 }}
                >
                  {order.orderNumber}
                </Typography>
              </View>
                ...
                <View key={item.id} style={styles.itemRow}>
                  ...
                  <View style={{ flex: 1, marginLeft: 12 }}>
                    ...
                    <Typography
                      ...
                      style={{ marginTop: 2 }}
                    >
                      {item.type === "tester" ? "Mini / Tester" : "Full Size"} •
                      Qty {item.quantity}
                    </Typography>
                  </View>
                  <Typography
