...
import { MapPin, X, ShieldCheck, Truck, User, Phone, CheckCircle2 } from 'lucide-react-native';
        ...
        <View style={[styles.card, { paddingBottom: Math.max(insets.bottom, 20) }]}>
          ...
          <View style={styles.header}>
            <View style={styles.headerLeft}>
              ...
              <View>
                <Typography style={styles.badge}>VERIFIED DESTINATION</Typography>
                <Typography style={styles.title}>Delivery Address Details</Typography>
              </View>
            </View>
          ...
          {orderNumber && (
            <View style={styles.orderRefRow}>
              <Typography style={styles.orderRefLabel}>ORDER REFERENCE</Typography>
              <Typography style={styles.orderRefValue}>{orderNumber}</Typography>
            </View>
          )}
          ...
          <View style={styles.logisticsCard}>
            ...
            <Typography style={styles.logisticsText}>
              Dispatched with tamper-proof luxury packaging and live door-to-door courier tracking.
            </Typography>
          </View>
