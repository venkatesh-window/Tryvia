...
export default function ProductForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.detail || "Failed to create product. Make sure category/brand references exist.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold font-brand text-text-primary">Add New Product</h1>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-background-paper p-6 rounded-2xl shadow-card border border-border-light space-y-5">
              ...
              <div>
                <label className="block text-sm font-medium text-text-primary mb-1.5 font-body">Product Name *</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
            ...
            <div className="bg-background-paper p-6 rounded-2xl shadow-card border border-border-light space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  <label className="block text-sm font-medium text-text-primary mb-1.5 font-body">Full Size Price (₹) *</label>
                  <input
                    type="number"
                    name="fullPrice"
          ...
          <div className="space-y-6">
            <div className="bg-background-paper p-6 rounded-2xl shadow-card border border-border-light space-y-5">
              <h3 className="font-semibold text-text-primary font-body border-b border-border-light pb-3">Product Image</h3>
            ...
            <div className="bg-background-paper p-6 rounded-2xl shadow-card border border-border-light space-y-5">
              ...
              <div>
                ...
                <p className="text-xs text-text-secondary mt-2">Active products are visible to customers in the TRYVIA app.</p>
              </div>
            </div>
          </div>
        </div>
